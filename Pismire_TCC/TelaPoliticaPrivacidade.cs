...
{
    public partial class TelaPoliticaPrivacidade : Form
    {
        ...
        {
            int x = (p_barra.Size.Width - lbl_politica.Width) / 2;
            int y = (p_barra.Size.Height - lbl_politica.Height);              //Posição da label na barra

            lbl_politica.Location = new Point(x, y);
        }

        private void p_barra_Resize(object sender, EventArgs e)
        {
            int x = (p_barra.Size.Width - lbl_politica.Width) / 2;
            int y = (p_barra.Size.Height - lbl_politica.Height);       //Posição da label na barra ao maximizar e desmaximizar 
