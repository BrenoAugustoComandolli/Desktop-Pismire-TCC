...
{
    public partial class TelaTermosUso : Form
    {
        public TelaTermosUso()
        {
            InitializeComponent();
        ...
        {
            int x = (p_barra.Size.Width - lbl_termos.Width) / 2;
            int y = (p_barra.Size.Height - lbl_termos.Height);              //Posição da label na barra

            lbl_termos.Location = new Point(x, y);
        }

        private void p_barra_Resize(object sender, EventArgs e)
        {
            int x = (p_barra.Size.Width - lbl_termos.Width) / 2;
            int y = (p_barra.Size.Height - lbl_termos.Height);       //Posição da label na barra ao maximizar e desmaximizar 
